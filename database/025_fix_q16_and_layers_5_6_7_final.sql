-- ============================================================================
-- Migration: 025_fix_q16_and_layers_5_6_7_final.sql
-- Purpose: Fix Layer 2 Q16 question text AND replace incorrect Layers 5, 6, 7
-- Date: 2026-01-15
-- 
-- CRITICAL ISSUES FIXED:
-- - Layer 2 Q16: Fix question text from "trust my own work" to "finalise or approve a project"
...
-- ============================================================================
-- STEP 2: FIX LAYER 2 Q16 QUESTION TEXT
-- ============================================================================

-- Fix Q16 (Architect version)
UPDATE quiz_questions 
SET question_text = 'Before I finalise or approve a project, the thing I double-check most carefully is:'
WHERE question_number = 'Q16' AND layer_number = 2;

-- Fix Q16a (Alchemist version)
UPDATE quiz_questions 
SET question_text = 'Before I finalise or approve a project, the thing I double-check most carefully is:'
WHERE question_number = 'Q16a' AND layer_number = 2;

-- Fix Q16m (Mixed version)
UPDATE quiz_questions 
SET question_text = 'Before I finalise or approve a project, the thing I double-check most carefully is:'
WHERE question_number = 'Q16m' AND layer_number = 2;

-- Verify Q16 fix
SELECT 'Q16 Fixed' as verification, question_number, question_text
FROM quiz_questions 
WHERE question_number IN ('Q16', 'Q16a', 'Q16m')
ORDER BY question_number;

-- ============================================================================
-- STEP 3: DELETE ALL INCORRECT QUESTIONS IN LAYERS 5, 6, 7
-- ============================================================================

DELETE FROM quiz_options WHERE question_id IN (SELECT id FROM quiz_questions WHERE layer_number = 5);
DELETE FROM quiz_questions WHERE layer_number = 5;

DELETE FROM quiz_options WHERE question_id IN (SELECT id FROM quiz_questions WHERE layer_number = 6);
DELETE FROM quiz_questions WHERE layer_number = 6;

DELETE FROM quiz_options WHERE question_id IN (SELECT id FROM quiz_questions WHERE layer_number = 7);
DELETE FROM quiz_questions WHERE layer_number = 7;

-- ============================================================================
-- STEP 4: INSERT CORRECT LAYER 5 QUESTIONS (NEURODIVERGENCE ASSESSMENT)
-- Q28-Q33: Focus patterns, learning preferences, sensory processing
-- ============================================================================

-- Q28: Focus patterns
INSERT INTO quiz_questions (question_number, layer_number, question_text, archetype_filter)
VALUES ('Q28', 5, 'Which description sounds most like how your focus naturally works?', NULL);

INSERT INTO quiz_options (question_id, option_key, option_text, option_description)
VALUES 
...
INSERT INTO quiz_questions (question_number, layer_number, question_text, archetype_filter)
VALUES ('Q29', 5, 'When learning or processing instructions, I usually…', NULL);
...
INSERT INTO quiz_questions (question_number, layer_number, question_text, archetype_filter)
VALUES ('Q30', 5, 'When my environment becomes overstimulating, I usually…', NULL);
...
-- Q31: Task management
INSERT INTO quiz_questions (question_number, layer_number, question_text, archetype_filter)
VALUES ('Q31', 5, 'Which sounds most like your experience managing tasks?', NULL);
...
INSERT INTO quiz_questions (question_number, layer_number, question_text, archetype_filter)
VALUES ('Q32', 5, 'Sensory input (noise, clutter, tension) affects me by:', NULL);
...
INSERT INTO quiz_questions (question_number, layer_number, question_text, archetype_filter)
VALUES ('Q33', 5, 'When I push myself mentally for long periods…', NULL);
...
-- ============================================================================
-- STEP 5: INSERT CORRECT LAYER 6 QUESTIONS (MINDSET & PERSONALITY)
-- Q34-Q39: Growth mindset, abundance mindset, personality traits
-- ============================================================================

-- Q34: Response to challenges (Growth vs Fixed)
INSERT INTO quiz_questions (question_number, layer_number, question_text, archetype_filter)
VALUES ('Q34', 6, 'When something stretches my abilities, my usual response is to:', NULL);
...
INSERT INTO quiz_questions (question_number, layer_number, question_text, archetype_filter)
VALUES ('Q35', 6, 'When opportunities or resources feel limited, I usually:', NULL);
...
INSERT INTO quiz_questions (question_number, layer_number, question_text, archetype_filter)
VALUES ('Q36', 6, 'When I face something new or unfamiliar, I tend to:', NULL);
...
INSERT INTO quiz_questions (question_number, layer_number, question_text, archetype_filter)
VALUES ('Q37', 6, 'In important situations, I usually show up feeling:', NULL);
...
INSERT INTO quiz_questions (question_number, layer_number, question_text, archetype_filter)
VALUES ('Q38', 6, 'When I''m working toward something meaningful, my natural pace is:', NULL);
...
INSERT INTO quiz_questions (question_number, layer_number, question_text, archetype_filter)
VALUES ('Q39', 6, 'When something matters to me, I tend to communicate in a way that:', NULL);
...
-- ============================================================================
-- STEP 6: INSERT CORRECT LAYER 7 QUESTIONS (VALUES & BELIEFS)
-- Q40-Q45: Locus of control, fairness, honesty, growth, impact
-- ============================================================================

-- Q40: Source of grounding (Self-Reliant vs Faith-Reliant vs Dual)
INSERT INTO quiz_questions (question_number, layer_number, question_text, archetype_filter)
VALUES ('Q40', 7, 'When life feels uncertain, I usually find grounding through:', NULL);
...
INSERT INTO quiz_questions (question_number, layer_number, question_text, archetype_filter)
VALUES ('Q41', 7, 'When I think about my future, I mainly believe that:', NULL);
...
INSERT INTO quiz_questions (question_number, layer_number, question_text, archetype_filter)
VALUES ('Q42', 7, 'When I think about fairness in the world, I tend to believe:', NULL);
...
INSERT INTO quiz_questions (question_number, layer_number, question_text, archetype_filter)
VALUES ('Q43', 7, 'When faced with a difficult choice, I usually prioritise:', NULL);
...
INSERT INTO quiz_questions (question_number, layer_number, question_text, archetype_filter)
VALUES ('Q44', 7, 'When I face a situation that pushes me outside my comfort zone, I usually:', NULL);
...
INSERT INTO quiz_questions (question_number, layer_number, question_text, archetype_filter)
VALUES ('Q45', 7, 'When I think about the impact I want to make, I''m most motivated by:', NULL);
...
SELECT 'Layer 2 Q16 Fixed' as verification, question_number, question_text
FROM quiz_questions 
WHERE question_number IN ('Q16', 'Q16a', 'Q16m')
ORDER BY question_number;
...
SELECT 'Question Count Per Layer' as verification, layer_number, COUNT(*) as question_count
FROM quiz_questions
...
-- ============================================================================
-- END OF MIGRATION - ALL ISSUES FIXED
-- ============================================================================
